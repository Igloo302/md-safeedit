...
describe('CLI Service Handlers', () => {
  ...
  it('inspects document outline correctly', () => {
    const res = inspectService({ file: { path: fullPath } } as any, [tempDir]) as any;
  ...
  it('reads nodes and issues mutation-capable anchors', () => {
    ...
    const inspectRes = inspectService({ file: { path: fullPath } } as any, [tempDir]) as any;
