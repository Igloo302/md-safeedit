...
function generateAllTasks() {
  ...
  for (let i = 1; i <= 40; i++) {
    ...
    writeTask(
      ...
      'local-edit',
      initialMd,
      initialMd, // No concurrent changes
      expectedMd,
      { category: 'local-edit', expected_outcome: 'commit' },
      { targetNodeType: 'paragraph', targetIndex: 1, replacementContent: replacement }
    );
  }
  ...
  for (let i = 1; i <= 20; i++) {
    ...
    writeTask(
      ...
      initialMd,
      currentMd,
      currentMd, // Reject: remains unchanged
      { category: 'ambiguity-reject', expected_outcome: 'reject' },
      { targetNodeType: 'paragraph', targetIndex: 0, replacementContent: replacement }
    );
  }
  ...
  for (let i = 1; i <= 20; i++) {
    ...
    writeTask(
      ...
      initialMd,
      expectedMd,
      { category: 'disambiguation', expected_outcome: 'commit' },
      { targetNodeType: 'paragraph', targetIndex: 1, replacementContent: replacement }
    );
  }
  ...
  for (let i = 1; i <= 20; i++) {
    ...
    writeTask(
      ...
      currentMd,
      expectedMd,
      { category: 'target-moved', expected_outcome: 'commit' },
      { targetNodeType: 'paragraph', targetIndex: 0, replacementContent: replacement }
    );
  }
  ...
  for (let i = 1; i <= 20; i++) {
    ...
    writeTask(
      id,
      'target-changed-reject',
      initialMd,
      currentMd,
      currentMd, // Reject: remains unchanged relative to current state
      { category: 'target-changed-reject', expected_outcome: 'reject' },
      { targetNodeType: 'paragraph', targetIndex: 0, replacementContent: replacement }
    );
  }
  ...
  for (let i = 1; i <= 20; i++) {
    ...
    writeTask(
      ...
      currentMd,
      currentMd, // Reject
      { category: 'target-deleted-reject', expected_outcome: 'reject' },
      { targetNodeType: 'paragraph', targetIndex: 0, replacementContent: replacement }
    );
  }
  ...
  for (let i = 1; i <= 20; i++) {
    ...
    writeTask(
      ...
      initialMd,
      expectedMd,
      { category: 'structural-filter', expected_outcome: 'commit' },
      { targetNodeType: 'paragraph', targetIndex: 0, replacementContent: replacement }
    );
  }
  ...
  for (let i = 1; i <= 15; i++) {
    ...
    writeTask(
      ...
      initialMd,
      expectedMd,
      { category: 'encoding-syntax', expected_outcome: 'commit' },
      { targetNodeType: 'paragraph', targetIndex: 0, replacementContent: replacement }
    );
  }
  ...
  for (let i = 1; i <= 15; i++) {
    ...
    writeTask(
      ...
      currentMd,
      expectedMd,
      { category: 'obsidian-block-id', expected_outcome: 'commit' },
      { targetNodeType: 'paragraph', targetIndex: 0, replacementContent: replacement }
    );
  }
  ...
  for (let i = 1; i <= 10; i++) {
    ...
    writeTask(
      ...
      initialMd,
      expectedMd,
      { category: 'transaction-batch', expected_outcome: 'commit' },
      { targetNodeType: 'paragraph', targetIndex: 0, replacementContent: replacement }
    );
  }
