 ...
 */
async function runTaskSession(taskId: string, targetFile: string, promptText: string) {
  console.log(`\n==================================================`);
...
async function main() {
  try {
    ...
    await runTaskSession(
      'task-001',
      'current.md',
      'Please update paragraph 2 to say: This is paragraph 2 updated version 1.'
    );
    ...
    await runTaskSession(
      'task-081',
      'current.md',
      'Please update paragraph A to say: This is paragraph A updated 1.'
    );
