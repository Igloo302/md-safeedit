 ...
 */
export function getCleanHeadingText(headingContent) {
 ...
 */
export function buildLogicalSections(parsedNodes, bytes, content) {
    ...
    const resultNodes = [];
    const sectionPointers = new Map(); // new section child ids
    ...
    function finalizeNode(nodeId, currentPath) {
